...
export class BamlAsyncClient {
  ...
  ): Promise<(GetWeatherReport | ComputeValue | MessageToUser | Resume)[]> {
    try {
      ...
      return raw.parsed(false) as (GetWeatherReport | ComputeValue | MessageToUser | Resume)[]
    } catch (error) {
...
class BamlStreamClient {
  ...
  ): BamlStream<((types.GetWeatherReport | null) | (types.ComputeValue | null) | (partial_types.MessageToUser | null) | (types.Resume | null) | null)[], (GetWeatherReport | ComputeValue | MessageToUser | Resume)[]> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const collector = options.collector ? (Array.isArray(options.collector) ? options.collector : [options.collector]) : [];
      ...
      return new BamlStream<((types.GetWeatherReport | null) | (types.ComputeValue | null) | (partial_types.MessageToUser | null) | (types.Resume | null) | null)[], (GetWeatherReport | ComputeValue | MessageToUser | Resume)[]>(
        raw,
        (a): ((types.GetWeatherReport | null) | (types.ComputeValue | null) | (partial_types.MessageToUser | null) | (types.Resume | null) | null)[] => a,
        (a): (GetWeatherReport | ComputeValue | MessageToUser | Resume)[] => a,
        this.ctxManager.cloneContext(),
      )
    } catch (error) {
      throw toBamlError(error);
