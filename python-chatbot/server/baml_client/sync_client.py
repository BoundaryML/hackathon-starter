...
class BamlStreamClient:
    ...
    def ChooseTools(
        ...
        state: types.State,query: types.Query,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[Optional[Union[types.GetWeatherReport, types.ComputeValue, partial_types.MessageToUser, types.Resume]]], List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[Optional[Union[types.GetWeatherReport, types.ComputeValue, partial_types.MessageToUser, types.Resume]]], List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]]](
        raw,
