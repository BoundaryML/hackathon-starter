...
class BamlAsyncClient:
    ...
    async def ChooseTools(
        self,
        state: types.State,query: types.Query,
        baml_options: BamlCallOptions = {},
    ) -> List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]]:
      ...
      return cast(List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]], raw.cast_to(types, types, partial_types, False))
    
    async def SummarizeMessages(
        self,
...
class BamlStreamClient:
    ...
    def ChooseTools(
        ...
        state: types.State,query: types.Query,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[List[Optional[Union[types.GetWeatherReport, types.ComputeValue, partial_types.MessageToUser, types.Resume]]], List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[List[Optional[Union[types.GetWeatherReport, types.ComputeValue, partial_types.MessageToUser, types.Resume]]], List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]]](
        raw,
        lambda x: cast(List[Optional[Union[types.GetWeatherReport, types.ComputeValue, partial_types.MessageToUser, types.Resume]]], x.cast_to(types, types, partial_types, True)),
        lambda x: cast(List[Union[types.GetWeatherReport, types.ComputeValue, types.MessageToUser, types.Resume]], x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
